...
const SUGGESTIONS: Array<{ title: string; sub: string; prompt: string }> = [
  ...
  },
  {
    title: '从某个节点开始跑',
    sub: '比如直接从分镜首帧入手',
    prompt: '我想直接跑 04 分镜首帧，缺的上游（剧本/资产）用合成 stub 顶上即可。',
  },
  {
    title: '完整链路（P0）',
    sub: '从选题到视频生成，按顺序推进',
    prompt: '从 01 选题开始，依次跑完 01→02→03→04→05。每步完成后简要汇报。（06-09 是 Phase 2，先跳过）',
  },
  {
    title: '分析一张参考图',
    sub: '上传图片让我提取风格 / 关键词',
    prompt: '我会上传一张参考图，请提取它的色彩、构图和氛围关键词，用于后续 Style Bible / 资产生成。',
  },
];
