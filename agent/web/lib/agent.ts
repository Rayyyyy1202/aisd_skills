...
export interface SiteSpec {
  ...
  updated_at: string;
  global: {
    project_name: FieldEnvelope<string>;
...
export const fetchSpec = (projectId: string): Promise<SpecResponse> =>
  getJSON(`/projects/${projectId}/spec`);

export const refreshSpec = (projectId: string): Promise<SpecResponse> =>
  getJSON(`/projects/${projectId}/spec/refresh`, { method: 'POST' });
...
export async function askField(
  ...
  await streamSSE(
    `${PROXY}/projects/${projectId}/spec/ask`,
    {
      method: 'POST',
      headers: { 'content-type': 'application/json' },
      body: JSON.stringify(body),
...
export async function buildFromSpec(
  ...
  await streamSSE(
    `${PROXY}/projects/${projectId}/spec/build`,
    {
      method: 'POST',
      headers: { 'content-type': 'application/json' },
      body: JSON.stringify(body),
